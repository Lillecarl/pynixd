...
let
  ...
  # working copy or a pinned store path, this is `<umbrella>/pynixd`.
  ...
  # `refs/umbrella/pynixd/*`. `umbrella mark` publishes them.
  #
  ...
  # `github:Lillecarl/pynixd`, a release tarball, or a pull request from a
